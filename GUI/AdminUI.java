...
public class AdminUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        clientIDTextArea = new javax.swing.JTextArea();
        ...
        usernameList.setBackground(new java.awt.Color(153, 153, 153));
        usernameList.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        jScrollPane4.setViewportView(usernameList);
        ...
        clientIDTextArea.setColumns(20);
        clientIDTextArea.setRows(5);
        jScrollPane6.setViewportView(clientIDTextArea);
    ...
    private void clientreqButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clientreqButtonActionPerformed
        ...
        AdminViewClientReq viewreq = new AdminViewClientReq();
    ...
    private javax.swing.JTextArea clientIDTextArea;
